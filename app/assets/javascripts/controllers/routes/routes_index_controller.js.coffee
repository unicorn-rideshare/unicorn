...
module.controller 'RoutesIndexCtrl', ['$scope', '$filter', '$controller', '$routeParams', 'Route', 'companyPreference',
  ($scope, $filter, $controller, $routeParams, Route, companyPreference) ->
