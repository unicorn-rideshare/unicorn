class PushWorkOrderProviderAddedJob
  ...
  def process
    work_order.work_order_providers.map { |work_order_provider| work_order_provider.invitations.create if work_order_provider.provider_id == provider.id } if provider.standalone?
